...
- 最后我们来看一下'CMMI-DEV V1.3'中是如何划定配置项范围的，意思差不多就是**整个产品开发过程所有相关的事物，都可以称之为配置项**：
...
- 说到基线首先我们要回顾一下项目开发的标准流程，以最基本的'瀑布式模型'来讲，项目开发标准过程按软硬结合、纯软件会分成以下两种：
	- 软硬结合：立项-需求分析-方案设计-软件/硬件/结构设计-样机-测试-试产-量产
	- 纯软件：立项-需求分析-概要设计-详细设计-编码-测试-发布
- 然后我这边整合了一份简易的开发流程文件管理规范，你可以先下载：[o(￣▽￣)d](http://pan.baidu.com/s/1i5a4EpB)，在这份流程文件中，开发流程是分为产品策划-方案设计-技术设计-试制-试产-确认
六个阶段，并要求每个阶段必须经过评审才可进行下一阶段。

- 在CMMI中，基线是经正式评审和同意的一组规格或者工作产品，据以用作未来发展的基础，而且仅能由变更管制程序变更。
- 变更管制我们先不讲，由CMMI的解释中，我们知道基线第一是要经过评审和同意的；第二它是由一组配置项组成的；第三它是用来衔接前后的，也就是我们平常说的承上启下，一个阶段的结束以及另一个阶段的开始
- 回到我们的项目开发流程中，可以看到这六个阶段都有各自需要确认的文件，且对文件有严格的发布要求，要进入下一阶段必须是上一阶段先通过评审。也就是说，在这种流程管理下，可以分为6个基线：
	- 产品策划基线，输出开发任务书指导下一步
	- 方案设计基线，输出外观设计需求说明、硬件方案、软件方案指导下一步进行详细的设计
	- 技术设计基线，
	- 样机

> 有关软件项目的基线，我找到一个关于基线说明比较详细的博文，直接看这篇吧[软件开发中的基线](http://www.cnblogs.com/emanlee/archive/2010/12/16/1908099.html)
